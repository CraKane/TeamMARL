...
def main(args, seed, i, fix_action=None, test_run=None, test_model=None, test_policy=None):
    ...
    run_dir = '../../results/population_idv_mappo/'
...
if __name__ == "__main__":
    ...
    test_policy_list = ['control_idv_mappo', 'population_idv_mappo_turn_update', 'population_idv_mappo_total_update']
    for i in range(len(seeds)):
        ...
        if i == 0:
            ...
            res = res.append(tmp)
    print(res)
    res.to_csv('../../results/mappo_test_generalization_result.csv', index=False)
