...
python train_mpe.py --check_eval --num_agents 4 --env_name MPE --experiment_name population_idv_mappo_total_update --idv_para True --num_env_steps 6000000


# simple spread

python train_mpe.py --check_eval --num_agents 4 --env_name MPE --experiment_name population_idv_mappo_total_update --idv_para True --num_env_steps 6000000 --scenario_name simple_spread

// 3-1
python test_generalization_mpe.py --num_agents 4 --env_name MPE --experiment_name population_idv_mappo_total_update --idv_para True --num_env_steps 200

// 2-2
python test_generalization_mpe.py --num_agents 4 --env_name MPE --experiment_name population_idv_mappo_total_update --idv_para True --num_env_steps 200 --my_policy 2