...
class ACTLayer(nn.Module):
    ...
    def forward(self, x, r, available_actions=None, deterministic=False):
        """
        Compute actions and action logprobs from given input.
        :param x: (torch.Tensor) input to network.
        :param r: (torch.Tensor) role feature.
    ...
    def get_probs(self, x, r, available_actions=None):
        """
    ...
    def evaluate_actions(self, x, r, action, available_actions=None, active_masks=None):
        """
